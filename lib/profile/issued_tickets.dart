...
class issuedtickets extends StatefulWidget {
  const issuedtickets({Key? key}) : super(key: key);

  @override
  State<issuedtickets> createState() => _issuedticketsState();
}

class _issuedticketsState extends State<issuedtickets> {
  @override
